...
extension UIColor {
    ...
    static func darkBlue() -> UIColor {
        return UIColor.rgb(red: 7, green: 17, blue: 63)
    }
    
    
    
    static func lightBlue() -> UIColor {
        return UIColor.rgb(red: 187, green: 190, blue: 202)
    }
    
    static func blueGray() -> UIColor {
        return UIColor.rgb(red: 131, green: 139, blue: 160)
    }
...
extension Date {
    ...
    func timeEventDateAndTimeDisplay() -> String {
        let secondsAgo = Int(Date().timeIntervalSince(self))
        ...
        return "in \(quotient) \(unit)\(quotient == 1 ? "" : "s")"
