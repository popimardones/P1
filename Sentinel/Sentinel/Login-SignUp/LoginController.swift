...
class LoginController: UIViewController {
    ...
    let logoContainerView: UIView = {
        ...
        let logoImageView = UIImageView(image: #imageLiteral(resourceName: "SentinelBanner"))
    ...
    let emailTextField: UITextField = {
        ...
        tf.backgroundColor = UIColor.rgb(red: 225, green: 254, blue: 255)
    ...
    let dontHaveAccountButton: UIButton = {
        ...
        let attributedTitle = NSMutableAttributedString(string: "Don't have an account?  ", attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 14), NSAttributedStringKey.foregroundColor: UIColor.white])
        
        attributedTitle.append(NSAttributedString(string: "Sign up here!", attributes: [NSAttributedStringKey.font: UIFont.boldSystemFont(ofSize: 14), NSAttributedStringKey.foregroundColor: UIColor.rgb(red: 8, green: 19, blue: 68)
            ]))
